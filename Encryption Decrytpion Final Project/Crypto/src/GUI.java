...
//        AlgOptions.addItem("Shacal2");
        ...
        Pwd = new JTextField("Enter your Key", 15);
        GBC.gridx = 1;
        GBC.gridy = 3;
        TEPanel.add(Pwd, GBC);
        ...
        FPwd = new JTextField("Enter your Key", 15);
        AlgPanel.add(FPwd);
        ...
        JLabel MyLabel = new JLabel("Crypto_ Cryptography Application");
        HRow2.add(MyLabel);
        
        JLabel MyLabel2 = new JLabel("          By Rishabh Saini");
        HRow2.add(MyLabel2);
